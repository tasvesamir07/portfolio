...
export const shouldSkipStringTranslation = (key = '', value = '', language = 'en'): boolean => {
...
export const collectStrings = (value: unknown, key = '', collected = new Set<string>(), lang = 'bn'): void => {
...
export const extractAllStrings = async (lang: string): Promise<Set<string>> => {
...
export const getHash = (text: string, lang: string): string => {
