...
const createRateLimiter = ({ windowMs, max, message, prefix }: RateLimiterConfig): Middleware => {
    if (redis) {
...
export = { loginLimiter, translateLimiter, messageLimiter, anonymousLimiter, globalLimiter };
