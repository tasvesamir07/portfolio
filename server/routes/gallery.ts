...
router.get('/', async (req: Request, res: Response) => {
    try {
        ...
        const result = await db.query('SELECT * FROM gallery ORDER BY sort_order ASC, id DESC LIMIT $1 OFFSET $2', [limit, offset]);
...
router.post('/', authenticateToken, validate(gallerySchema), async (req: Request, res: Response) => {
    ...
    try {
        ...
        translateOnSave('gallery', req.body).catch((err: any) => logger.error({ err }, 'Translation background error'));
