...
const AdminTrainings = () => {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            if (formData.id) {
                await api.put(`/trainings/${formData.id}`, structuredPayload);
            } else {
                await api.post('/trainings', structuredPayload);
            }
    ...
    const handleMove = async (index, direction) => {
        ...
        try {
            await api.put('/reorder/trainings', { orders });
            clearTranslationCache();
            clearResponseCache();
            fetchData();
        } catch (err) {
