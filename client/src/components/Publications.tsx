                                ...
                                <div className="flex-grow flex flex-col justify-start">
                                    <div className="flex flex-col sm:flex-row gap-6 mb-2">
                                        ...
                                        <div className="text-left flex-grow flex flex-col justify-center">
                                            <h3 className="text-xl sm:text-2xl font-black text-gray-900 leading-snug mb-4 flex items-baseline gap-2.5">
                                                <span className="text-[#8c2626] font-bold text-xs sm:text-sm select-none shrink-0">
