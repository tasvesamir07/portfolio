...
interface SocialPlatform {
  id: string;
  label: string;
  icon: IconType | React.ComponentType<SocialIconProps>;
  color: string;
  colorClass: string;
}

export const socialIconMap: Record<string, IconType | React.ComponentType<SocialIconProps>> = {
  github: FaGithub,
  linkedin: FaLinkedin,
  twitter: FaTwitter,
...
export const getSocialIcon = (name: string): IconType | React.ComponentType<SocialIconProps> => {
